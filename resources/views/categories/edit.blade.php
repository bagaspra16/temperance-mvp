...
<div class="container mx-auto max-w-6xl px-4">
    ...
    <div class="bg-dark-200 rounded-2xl shadow-xl border border-dark-100/20 backdrop-blur-sm" 
        ...
        <div class="p-8 border-b border-dark-100/20">
            ...
            <p class="text-gray-400">Update your category settings and preferences</p>
        </div>
            ...
            @method('PUT')
                        ...
                        <div class="form-group" data-aos="fade-up" data-aos-delay="200">
                            ...
                            <div class="mt-4 flex items-center space-x-8">
                                ...
                                <div class="flex flex-col p-4 bg-dark-400/95 rounded-xl border border-dark-100/30 backdrop-blur-sm shadow-inner">
                                    <span class="text-white text-xl font-mono tracking-wider" id="color-value">{{ $category->color_code }}</span>
                                    <div class="flex items-center mt-3 space-x-3">
                                        <span class="w-10 h-10 rounded-full shadow-lg" id="color-preview" style="background-color: {{ $category->color_code }}"></span>
                ...
                @enderror
                    ...
                    <div class="form-group" data-aos="fade-up" data-aos-delay="300">
                        <div class="flex justify-between items-center mb-4">
                            ...
                            <div class="relative w-64">
                                <input type="text" 
                                       id="icon-search" 
                                       class="w-full bg-dark-400/95 border border-dark-100/30 rounded-xl pl-10 pr-4 py-2.5 focus:ring-2 focus:ring-accent/30 focus:border-accent/50 transition-all text-white placeholder-gray-400 shadow-inner backdrop-blur-sm"
                    ...
                    @endphp
                                ...
                                @foreach($iconCategories as $categoryName => $icons)
                                    <div class="col-span-full">
                                        <h3 class="category-header">{{ $categoryName }}</h3>
                                        <div class="icon-grid">
                                            @foreach($icons as $iconName => $label)
                                                <div class="icon-option group {{ $category->icon === $iconName ? 'selected' : '' }}"
                                                    data-icon="{{ $iconName }}"
                                                    ...
                                                    <div class="icon-tooltip">
                                                        ...
                                                        <div class="text-xs text-gray-400 mt-1">{{ $categoryName }}</div>
                                                    </div>
                                                </div>
                                            @endforeach
                                        </div>
